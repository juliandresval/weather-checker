...
final class Version20210622022247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ciudades (id INT AUTO_INCREMENT NOT NULL, owm_id INT DEFAULT NULL, zip_code INT DEFAULT NULL, name VARCHAR(127) NOT NULL, findname VARCHAR(127) DEFAULT NULL, state VARCHAR(3) DEFAULT NULL, country VARCHAR(3) NOT NULL, lat NUMERIC(10, 7) DEFAULT NULL, lon NUMERIC(10, 7) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE historial (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, date DATE DEFAULT NULL, temp DOUBLE PRECISION DEFAULT NULL, hum DOUBLE PRECISION DEFAULT NULL, INDEX historial_ciudades_id_fk (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE historial ADD CONSTRAINT FK_269506528BAC62AF FOREIGN KEY (city_id) REFERENCES ciudades (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE historial DROP FOREIGN KEY FK_269506528BAC62AF');
